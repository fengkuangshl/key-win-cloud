...
//            System.out.println("Decrypt result from ios client: \n" + decryptStringFromIOS);
    ...
    public String decryptWithBase64(String base64String) throws Exception {
        ...
        byte[] binaryData = decrypt(getPrivateKey(), decoder.decode(base64String) /*org.apache.commons.codec.binary.Base64.decodeBase64(base46String.getBytes())*/);
    ...
    public String encryptWithBase64(String string) throws Exception {
        ...
        String base64String = new String(encoder.encode(binaryData)); /* org.apache.commons.codec.binary.Base64.encodeBase64(binaryData) */;
        return base64String;
    }
