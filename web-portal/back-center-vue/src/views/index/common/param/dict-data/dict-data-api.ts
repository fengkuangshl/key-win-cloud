...
export const DeleteSysDictDataApi = (id: number): Promise<KWResponse.Result> => request.delete(settings.apiParam + 'sysDictData/delete/' + id)
...
export const SysDictDataGetApi = (id: number): Promise<KWResponse.Result<SysDictData>> => request.get(settings.apiParam + 'sysDictData/get/' + id)
