...
export const DeleteSysDictTypeApi = (id: number): Promise<KWResponse.Result> => request.delete(settings.apiParam + 'sysDictType/delete/' + id)
...
export const SysDictTypeGetApi = (id: number): Promise<KWResponse.Result<SysDictType>> => request.get(settings.apiParam + 'sysDictType/get/' + id)
