...
export const DeleteSysDictTreeApi = (id: string): Promise<KWResponse.Result> => request.delete(settings.apiParam + 'sysDictTree/delete/' + id)
...
export const SysDictTreeGetApi = (id: string): Promise<KWResponse.Result<SysDictTree>> => request.get(settings.apiParam + 'sysDictTree/get/' + id)
export const GetSysDictTreeByTypeApi = (type: string): Promise<KWResponse.Result<Array<SysDictTree>>> => request.get(settings.apiParam + 'sysDictTree/getDictTree/' + type)
