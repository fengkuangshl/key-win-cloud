...
export const GetMenuByRoleIdApi = (roleId: number): Promise<KWResponse.Result<Array<MenuRole>>> => request.get(settings.apiUser + 'menu/' + roleId)
...
export const DeleteSysMenuApi = (id: number): Promise<KWResponse.Result> => request.delete(settings.apiUser + 'menu/delete/' + id)
...
export const GetMenuByIdApi = (id: number): Promise<KWResponse.Result<MenuResponse>> => request.get(settings.apiUser + 'menu/get/' + id)
