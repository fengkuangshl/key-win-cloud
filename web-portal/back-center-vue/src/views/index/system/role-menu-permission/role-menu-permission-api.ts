...
export const GetPagePermissionApi = (roleId: string): Promise<KWResponse.Result<SysRoleMenuPermissionResponse>> => request.get(settings.apiUser + 'sysrmpc/get/grant/' + roleId)
