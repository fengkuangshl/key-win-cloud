...
export const UserGetApi = (id: string): Promise<KWResponse.Result<UserInfo>> => request.get(settings.apiUser + 'user/getUserFullById/' + id)
...
export const ResetPasswordApi = (id: string): Promise<KWResponse.Result<UserInfo>> => request.get(settings.apiUser + 'user/resetPassword/' + id)
