...
public class JpaFeignClientCtrl {

    @Autowired
    private JpaFeignClientService jpaFeignClientService;
    ...
    public PageResult<JpaFeignTemplateVo> getJpaFeignTemplateByPaged(@RequestBody PageRequest<JpaFeignTemplateVo> t) {
        return jpaFeignClientService.getJpaFeignTemplateByPaged(t);
    }
    ...
    public Result saveOrUpdateJpaFeignTemplate(@RequestBody JpaFeignTemplateVo jpaTemplate){
        return  jpaFeignClientService.saveOrUpdateJpaFeignTemplate(jpaTemplate);
    }
    ...
    public JpaFeignTemplateVo get(@PathVariable String id) {
        return jpaFeignClientService.get(id);
    }
    ...
    public Result delete(@PathVariable String id) {
        return jpaFeignClientService.delete(id);
    }
